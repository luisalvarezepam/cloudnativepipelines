...
module "log_analytics" {
  source = "git::https://#{org_name}#@dev.azure.com/#{org_name}#/#{project_name}#/_git/#{project_name}#//iac/terraform/terraform.azurerm.log_analytics?ref=develop"
...
#############################################################################################
module "vnet" {
  source = "git::https://#{org_name}#@dev.azure.com/#{org_name}#/#{project_name}#/_git/#{project_name}#//iac/terraform/terraform.azurerm.vnet?ref=develop"
  depends_on = [
    module.rg_vnet
  ]
...
module "azurecontainerregistry" {
  source = "git::https://#{org_name}#@dev.azure.com/#{org_name}#/#{project_name}#/_git/#{project_name}#//iac/terraform/terraform.azurerm.azure_container_registry?ref=develop"
  depends_on = [
    module.rg_st
  ]
  name                          = var.acr.name
...
#############################################################################################
module "aks" {
  source = "git::https://#{org_name}#@dev.azure.com/#{org_name}#/#{project_name}#/_git/#{project_name}#//iac/terraform/terraform.azurerm.aks?ref=develop"
  depends_on = [
    module.rg_aks,
    module.rg_vnet,
    module.vnet
...
module "private_endpoint" {
  source = "git::https://#{org_name}#@dev.azure.com/#{org_name}#/#{project_name}#/_git/#{project_name}#//iac/terraform/terraform.azurerm.private_endpoint?ref=develop"
  depends_on = [
    module.vnet,
    module.cosmosdb_account
  ]
...
# Create alerts
module "alerts" {
  source                      = "git::https://#{org_name}#@dev.azure.com/#{org_name}#/#{project_name}#/_git/#{project_name}#//iac/terraform/terraform.azurerm.alerts?ref=develop"
  depends_on                  = [
    module.monitor_action_group,
    module.aks
  ]
